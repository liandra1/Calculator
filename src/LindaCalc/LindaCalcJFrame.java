...
public class LindaCalcJFrame {
	...
	private void initialize() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					...
					if (operations == "+") {
						...
						svar = String.format("%.2f", bas.proc(first, second));
						textField.setText(svar);
					}		
		        }
		        catch (Exception d){
		...
		btn_procent.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btn_procent.setBounds(323, 207, 52, 39);
		frmLindasKalkylator.getContentPane().add(btn_procent);
